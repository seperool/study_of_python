...
jupyter: python3
bibliography: python_bibliografia.bib
---
...
Uma lista é uma coleção de itens em uma ordem em particular. Os colchetes([]) indicam uma lista e os elementos individuais de uma lista são separados por vírgula.
