...
A expressão `:02d` e `:.2f` dentro das chaves formatam os valores para respectivamente: um número inteiro com 2 digitos, se ele possuir menos de 2 digitos, preencha com zeros a esquerda; e que deseja trabalhar com ponto flutuante e a quantidade de casas decimais.
...
#| warning: false
#| label: tbl-fstring
#| tbl-cap: Tipos de formatações f-string.
